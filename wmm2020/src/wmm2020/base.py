...
def wmm_unique(glat: float, glon: float, alt_km: float, yeardec: float) -> dict:
    """
    wmm computes the value of the world magnetic model at a specific unique points specified by glat and
    glon, and a single altitude value. glat and glon should be in degrees.
